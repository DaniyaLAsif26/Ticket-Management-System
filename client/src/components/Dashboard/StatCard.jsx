export default function StatCard({ data }) {
    ...
    return (
        <div className={`bg-[#21222d] rounded-xl text-white px-3 py-3 border-t-2 border-[#80c0e9]`}>
            ...
            <div className="font-semibold text-[2rem] py-3 border-b-[0.5px] border-gray-400">{data.data}</div>
